...
<img src="assets/bg.png" width="100%" alt="Banner"/>
 ...
 🚀 About Me
I'm a Full Stack (MERN) Developer and Computer Science & Engineering undergraduate at Bangladesh University of Professionals (BUP). Over the last 6 months I completed an intensive full-stack development program — React, Next.js, TypeScript, Node.js, Express, MongoDB, and Firebase — and used it to ship several production-style web apps with real authentication, payments, and role-based dashboards. I enjoy turning a messy requirement into a clean, working product, and I'm now exploring how AI-assisted workflows can help me build and ship faster without cutting corners on quality.
